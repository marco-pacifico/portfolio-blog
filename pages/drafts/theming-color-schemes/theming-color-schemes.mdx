...
The majority of theme variables will be for colors. Shopify Polaris has x, Adobe's Spectrum has y. Figma's has z. 

[Graphic: Theme variables -- percentatge color, typography, other styles]

Why so many? Wouldn't just a handful of color variables work? 

In this post I'll explore why color turns out to be the most complex part of theming (i.e. why the majority of theme variables are for colors) and how to define the colors in a theme. 
...
Broadly speaking, color has two main jobs: convey meaning and help guide a person's attention. From these two high level jobs, a variety of other jobs emerge at more granular levels of detail in the interface. And it's this variety of jobs that makes color the most complex part of a theme.
