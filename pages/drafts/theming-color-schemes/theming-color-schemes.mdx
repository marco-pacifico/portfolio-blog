...
Color is the deepest, most complex part of theming. If you look at Shopify's Polaris or Adobe's Spectrum or Figma's design system, and count their theme variables, most of the variables are for colors. 

[Graphic: Theme variables -- percentatge color, typography, other styles]

Color is obviously important. It's a highly noticeable part of brand's visual identity. But so is typography. What is it about color that requires so many theme variables? 
...
Broadly speaking, color has two main jobs: convey meaning and help guide a person's attention. 
