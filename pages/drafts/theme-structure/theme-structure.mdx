...
- To `text` 
- To convey `brand` 
- At a `most prominent` level of contrast
...
The modifiers `neutral` and `primary` represent the most common, most used variants of the style. Only variants that differ from the defaults need to be specified.
...
One last callout here is to only create specialty names when the more general names don't work. The fewer variable names the better. 
