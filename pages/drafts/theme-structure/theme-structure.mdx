...
In a table or similar data structure, choose values for each semantic variable for each theme. These values determine the look and feel of each theme, so they should come from a design spec, where all values have been chosen for specific reasons and because they work well together.
...
### Use constants or design tokens representing literal values
