...
You want the list of properties to be short, so you can name them and remember them. And so it's not too complicated and tedius to work with and configure a theme.
