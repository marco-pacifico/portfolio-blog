...
Another option would be add a prop to each component that lets you change some of the styles. For example, you could have a color prop on the button.  purple button vs blue button.
