...
As an aside, it’s interesting that chat and autocomplete in a text editor are the two interfaces that have had the most traction with me, probably because they go with the grain of the underlying technology. Many tools have taken more of a "right click to do something using AI" approach that can feel bolted on and not seamlessly integrated into a workflow. Obviously we’re still in the early days and people are still experimenting and figuring out what works.
...
Occationally I’ll ask for help finding the right word or making sure I’m using the correct terminology. 
...
It’s interesting that even "bad" suggestions can be helpful because they help me eliminate options and can spark ideas. When I see something I know I don’t want, it can drive me to think of what I do want. I think, *no that’s all wrong, I want to say it this way instead.* 
...
The downside is that it’s literally finishing my sentences, which can be somewhat annoying and intrusive. It can influence me to go in a direction I wasn’t planning on going. It will suggest something and I’ll think, *hmm that sounds reasonalble, I’ll go with that* and then I’ll realize it’s a bunch of fluff I didn’t need. I need more time with it to decide if it’s more helpful than not. 

## Going forward
I want to find more ways to use and benefit from AI in everyday life. I also want to experiment using the APIs to build tools that help me get things done.

Aside from Copilot and other autocomplete features, using AI still feels like something I have to remember to do vs. something that’s just there and I use without thinking about it.
...
I’m also curious to see how quaint this post will seem in the future.

It’s been exciting to see this technology emerge and be rapidly adopted and improved in such a short period of time. I’m looking forward to seeing how things progress in 2024.