...
- **v0 by Vercel** for generating interfaces writen in React and Tailwind 
...
## Going forward
I'll keep finding more ways to use AI in everyday life. I'd also like to use the APIs to build tools that help me get things done.

Aside from Copilot and other autocomplete features, AI still feels like something I have to actively work on and practice using. 
