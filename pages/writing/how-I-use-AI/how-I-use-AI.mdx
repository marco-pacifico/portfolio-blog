...
date: "2023-12-29"
category: Blog Post
description: Documenting how I used AI in 2023
slug: how-I-use-AI
---
...
The cool thing is, this can be a two-way conversation. I’d often ask follow up questions to clarify things I didn’t understand.
...
The thing is sometimes it actually is 100% wrong and sometimes it’s only sort of right. So you have to have some base knowledge and ways of validating what it says to use it effectively as a tutor. 
...
When it comes to fixing issues, I've either pasted in an error message and asked, *"How would you fix this error?"* or *"What does this error mean?"* or *"What's causing this error?"* Or I've pasted in my code and asked why the code isn't doing what I'm expecting it to do.
