...
This is what a block of code looks like `inline code`. What about when it's in a paragraph? Multiple lines that wrap? `inline code` What about when it's in a paragraph? Multiple lines that wrap? What about when it's in a paragraph? Multiple lines that wrap? What about when it's in a paragraph? Multiple lines that wrap? What about when it's in a paragraph? Multiple lines that wrap?
