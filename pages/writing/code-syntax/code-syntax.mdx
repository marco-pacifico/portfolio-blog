...
I recently implemented code syntax highlighting on my blog. I'm using [Prism.js](https://prismjs.com/) to do this. It's a pretty simple setup, but I wanted to document it here for future reference. 
