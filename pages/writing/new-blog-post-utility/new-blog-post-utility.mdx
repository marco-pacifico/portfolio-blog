...
Inspired by Josh Comeau's [create-new-component utility](https://www.npmjs.com/package/new-component), I wrote a utility to create the boilderplate folder structure and files for a new blog post. 
