...
I love how a grid pattern creates a feeling of technical precision and engineering. Whenever I see one I'm alway curious to know how it was implemented.
...
What I mean by parameterizing is making certain properties of the grid dynamic so they can be adjusted.
...
To achieve this, I added the `aria-hidden` attribute to the root element of the `<GridPattern />` component. Since `aria-hidden` is inherited by all child elements, the grid pattens and visual effects will be hidden from screen readers. 
