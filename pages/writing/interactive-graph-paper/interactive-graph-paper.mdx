...
I love how a grid pattern gives a sense of technical precision and engineering Whenever I see one, I'm alway curious to learn how it was implemented.
...
To achieve this, I'm using adding the `aria-hidden` attribute on the root element of the `<GridPattern />` component. Since `aria-hidden` is inherited by all child elements, all the gridliens and visual effects will be hidden from screen readers. 
