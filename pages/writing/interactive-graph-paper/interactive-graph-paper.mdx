...
To draw the decorations, I'm mapping through an array of coordinates. The coordinates render a `<path>` element for the squares or `<circle>` elements for the circles.
