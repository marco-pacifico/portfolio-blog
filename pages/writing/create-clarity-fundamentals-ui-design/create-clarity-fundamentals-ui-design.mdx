...
## Create Hierarchy
One of the most effective ways to provide clarity is to communicate the relative importance of elements on the page. That is to <Link href="/writing/create-hierarchy-fundamentals-ui-design">create hierarchy</Link>.
