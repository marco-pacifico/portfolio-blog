...
const postsDirectory = path.join(process.cwd(), "pages/drafts");
...
const staticFileDirectory = path.join(process.cwd(), '/data/DRAFTS.js');
const draftsData = getSortedDraftsData();
const data = "const DRAFTS = " + JSON.stringify(draftsData) + "; export default DRAFTS;";
fs.writeFile(staticFileDirectory, data ,(err) => err && console.error(err));